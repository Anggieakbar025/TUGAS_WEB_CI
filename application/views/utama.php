<main role="main">
    ...
    <br> <br>
		<div class="row featurette conten">
			<div class=" keterangankiri ">
				<h1 class="featurette-heading">Touring Pulau Jawa. <span class="text-muted">Sekaligus Rekreasi.</span></h1>
			...
			<div class="col-md-5">
				<img src="<?= base_url()?>/assets/img/event1.jpg" width="500px">
			</div>
		</div>
    <br> <br>
		<hr class="featurette-divider">
    <br> <br>
		<div class="row featurette">
			<div class="col-md-6 order-md-3 keterangankanan">
				<h1 class="featurette-heading">Bikers Gathering, <span class="text-muted">dan Sharing antar bikers.</span></h1>
				<p class="lead">Donec ullamcorper nulla non metus auctor fringilla. Vestibulum id ligula porta felis euismod
					semper.
					Praesent commodo cursus magna, vel scelerisque nisl consectetur. Fusce dapibus, tellus ac cursus commodo.</p>
			</div>
			<div class="col-md-5 order-md-2">
				<img src="<?= base_url()?>/assets/img/event2.jpg" width="500px">
			</div>
		</div>
    <br> <br>
		<hr class="featurette-divider">
    <br> <br>
		<div class="row featurette">
			<div class=" keterangankiri">
				<h1 class="featurette-heading">Pameran Motor, <span class="text-muted">dan Cutom Competition .</span></h1>
				<p class="lead">Donec ullamcorper nulla non metus auctor fringilla. Vestibulum id ligula porta felis euismod
					semper.
					Praesent commodo cursus magna, vel scelerisque nisl consectetur. Fusce dapibus, tellus ac cursus commodo.</p>
			</div>
			<div class="col-md-5">
				<img src="<?= base_url()?>/assets/img/event3.jpg" width="500px">
			</div>
		</div>
    <br><br>
		<hr class="featurette-divider">
