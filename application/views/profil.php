<div class="container marketing">
	...
	<div class="row mt-5 mb-5 text-center">
		<div class="col-lg-4">
			<svg class=" rounded-circle" width="140" height="140" focusable="false" role="img" aria-label="Placeholder: 140x140">
				<title>Placeholder</title>
				<rect fill="#777" width="100%" height="100%" /><text fill="#777" dy=".3em" x="50%" y="50%">140x140</text>
			</svg>
			<h2>Heading</h2>
